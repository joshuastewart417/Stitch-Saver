...
return (
    <>
        <div className="list_wrapper">
            <div className="list_item">{dmcThreads[0][0]}: rgb({dmcThreads[0][1]}, {dmcThreads[0][2]}, {dmcThreads[0][3]})</div>
            <div className="list_item">{dmcThreads[3][0]}: rgb({dmcThreads[3][1]}, {dmcThreads[3][2]}, {dmcThreads[3][3]})</div>
            <div className="list_item">{dmcThreads[6][0]}: rgb({dmcThreads[6][1]}, {dmcThreads[6][2]}, {dmcThreads[6][3]})</div>
            <div className="list_item">{dmcThreads[9][0]}: rgb({dmcThreads[9][1]}, {dmcThreads[9][2]}, {dmcThreads[9][3]})</div>
            <div className="list_item">{dmcThreads[12][0]}: rgb({dmcThreads[12][1]}, {dmcThreads[12][2]}, {dmcThreads[12][3]})</div>
            <div className="list_item">{dmcThreads[15][0]}: rgb({dmcThreads[15][1]}, {dmcThreads[15][2]}, {dmcThreads[15][3]})</div>
            <div className="list_item">{dmcThreads[18][0]}: rgb({dmcThreads[18][1]}, {dmcThreads[18][2]}, {dmcThreads[18][3]})</div>
            <div className="list_item">{dmcThreads[21][0]}: rgb({dmcThreads[21][1]}, {dmcThreads[21][2]}, {dmcThreads[21][3]})</div>
